        ...
        protected override void Seed(Blog.Data.Context.BlogContext context)
        {
            var articles = new List<Article>
            {
                ...
                new Article
                {
                    ...
                    ArticleBody =
                        @"<p>Facebook’s data privacy problems have had little impact on its profitability as the company posted record revenues for the first quarter of 2018.</p><br/>
